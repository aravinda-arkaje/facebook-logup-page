...
<body>
	<div class="header col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="container col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="heading-logo col-lg-6 col-md-6 col-sm-4 col-xs-6">
				<a href="" class="logo">
					<img width="35%" src="<?php echo base_url(); ?>images/facebook-white.png">
				</a>
			</div>
	...
	<div class="register-area">
		<div class="container">
			<div class="left-content col-lg-6 col-md-6 col-sm-12 col-xs-12">
				<div class="content-one col-lg-12 col-md-12 col-sm-12 col-xs-12">
					Facebook helps you connect and share with the people in your life.
				</div>
				<img class="img col-lg-12 col-md-12 col-sm-12 col-xs-12" src="<?php echo base_url(); ?>images/graf.png">
			</div>
			<div class="reight-content col-lg-6 col-md-6 col-sm-12 col-xs-12">
	...
	<div class="pagefooter col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="container col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="languages col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<ul>
					<li>
						English (UK)
					</li>
			...
			<div class="footer-row col-lg-12 col-md-12 col-sm-12 col-xs-12"></div>
			<div class="page-info col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<table class="info-table col-lg-12 col-md-11 col-sm-11 col-xs-11" cellpadding="0" cellspacing="0">
					<tr>
						<td class="page1 col-lg-1 col-md-1 col-sm-1 col-xs-1">
						<a href="">Sign Up</a>
						</td>
						<td class="page2 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Log In</a></td>
						<td class="page3 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Messenger</a></td>
						<td class="page4 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Facebook Lite</a></td>
						<td class="page5 col-lg-1 col-md-1 col-sm-1 col-xs-1 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Mobile</a></td>
						<td class="page6 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Find Friends</a></td>
						<td class="page7 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">People</a></td>
						<td class="page8 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Pages</a></td>
						<td class="page9 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Places</a></td>
						<td class="page10 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Games</a></td>
						<td class="page11 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Locations</a></td>
					</tr>
					<tr>
						<td class="page12 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Celebrities</a></td>
						<td class="page13 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Marketplace</a></td>
						<td class="page14 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Groups</a></td>
						<td class="page15 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Recipes</a></td>
						<td class="page16 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Sports</a></td>
						<td class="page17 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Moments</a></td>
						<td class="page18 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Instagram</a></td>
						<td class="page19 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">About</a></td>
						<td class="page20 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Premium privacy policy</a></td>
						<td class="page21 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Standard privacy policy</a></td>
						<td class="page22 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Cookies</a></td>
					</tr>
					<tr>
						<td class="page23 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Acceptable Use Policy</a></td>
						<td class="page24 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Standard Terms of Service</a></td>
						<td class="page25 col-lg-1 col-md-1 col-sm-1 col-xs-1"><a href="">Help</a></td>
					</tr>
				</table>
			</div>
